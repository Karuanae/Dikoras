    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <p className="text-blue-600 text-sm mb-4">Client: John Smith</p>
          <div className="flex justify-between items-center">
            <span className="text-blue-600 text-sm">Due: Jan 30, 2024</span>
        ...
        <div className="bg-green-50 rounded-xl p-6 border border-green-200">
          ...
          <p className="text-green-600 text-sm mb-4">Client: Sarah Johnson</p>
          <div className="flex justify-between items-center">
            <span className="text-green-600 text-sm">Completed: Jan 15, 2024</span>
        ...
        <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
          ...
          <p className="text-yellow-700 text-sm mb-4">Status: Pending Review</p>
          <p className="text-yellow-600 text-sm mb-4">Client: Mike Wilson</p>
          <div className="flex justify-between items-center">
            <span className="text-yellow-600 text-sm">Submitted: Jan 25, 2024</span>
